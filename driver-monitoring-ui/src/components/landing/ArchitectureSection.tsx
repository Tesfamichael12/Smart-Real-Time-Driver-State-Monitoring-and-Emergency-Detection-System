...
const nodes = [
  ...
  { id: 'gps', label: 'GPS Location', icon: MapPin, color: 'text-state-normal', border: 'border-state-normal/30', bg: 'bg-state-normal/10', desc: 'NEO-6M GPS module provides live coordinates with fallback to preset demo location (Addis Ababa, Ethiopia).' },
